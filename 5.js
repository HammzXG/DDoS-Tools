...
const secureOptions =
 ...
 const MAX_RAM_PERCENTAGE = 600;
const RESTART_DELAY = 1000;

if (cluster.isMaster) {
    console.log("═════════════════════════════════════════════════════════════".gray);
    console.log(` HAMMZXG DDOS ATTACK`.red.bold);
    console.log("═════════════════════════════════════════════════════════════".gray);
    ...
    console.log("═════════════════════════════════════════════════════════════".gray);
    console.log("HAMMZXG DDOS | HIGH RQ/S GLORY CUSTOM".yellow.bold);
    ...
    const handleRAMUsage = () => {
        ...
        const ramPercentage = (usedRAM / totalRAM) * 1000;
